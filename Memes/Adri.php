...
<body>
  ...
  <div class="container-fluid" >
        ...
        <!-- Titulo -->
          <p class="ttlIntroducao">Adriana Lima</p>
          
          <!-- Imagem -->
          <div class="ImgMeme"> 
          <img src="../imagens/Memes/Adri.jpg" width="1050px" height="600px" margin="px" >
          </div>
          ...
          <p class="topicoArt">
	      	...
	      	<p class="Arttexto">
              Adriana Lima da Silva é um dos maiores nomes das passarelas internacionais. A brasileira, hoje com 36 anos, começou sua carreira como Victoria’s Secret Angel, em 1999 (ano em que fez seu primeiro desfile pela marca). Atualmente, além de ser embaixadora da grife, Adriana é uma das modelos que mais desfilou usando as famosas lingeries – sendo inclusive nomeada, em 2017, como a Angel mais valiosa da Victoria’s Secret. Como já bem disse a modelo, “tem muita mídia, eu acho!”.
                Voltando um pouco no tempo, em 2002, no início de sua carreira de modelo internacional, Adriana Lima deu uma entrevista um tanto quanto “inusitada” ao jornalista Francisco Chagas.</p>
              <p class="topicoArt">
              Difusão e Repercussão
              </p>
              <p class="Arttexto1">
              Os memes de Adriana Lima se difundiram fortemente nas redes sociais, como o Twitter, Facebook e YouTube, nos anos de 2016 e 2017 –  assumindo diversos gêneros e formatos.
              No desfile da Victoria’s Secret de 2016, Adriana Lima mandou o “famoso beijinho” para a câmera, levando alguns internautas a dizerem que a top model estaria revivendo um de seus maiores e mais famosos memes.</p>
