...
<body>
  ...
  <div class="container-fluid" >
        ...
        <!-- Titulo -->
          <p class="ttlIntroducao">Akon Aconselha</p>
          
          <!-- Imagem -->
          <div class="ImgMeme"> 
          <img src="../imagens/Memes/Akon.jpg" width="1050px" height="600px" margin="px" >
          </div>
          ...
          <p class="topicoArt">
	      	...
	      	<p class="Arttexto">
              Akon Aconselha é um meme que consiste do famoso cantor  apontando para uma foto que, acompanhada de uma legenda, faz parecer que o artista está dando conselhos aos internautas. Foi criado em abril de 2018, e obteve um enorme crescimento ao longo do mês – fazendo, inclusive, com que as pesquisas referentes ao nome do cantor crescessem durante este período. Com a notoriedade esporádica, as montagens foram se tornando cada vez mais recorrentes, principalmente nas regiões Sul e Sudeste (com um destaque especial para os Estados do Rio de Janeiro, São Paulo e Paraná, como informa as estatísticas no Google Trends).
              </p>
              
              <p class="Arttexto1">
              O meme atraiu a atenção de veículos jornalísticos famosos, como a BBC Brasil  (numa polêmica matéria sobre o uso destes memes pelo Tribunal Regional do Trabalho de Mato Grosso), por exemplo.

Este grande alcance, em um pequeno período de tempo, foi assunto também em matérias de portais de notícias, como o R7  Folha e G1. Ilustrando o crescimento em números, a procura pelo nome de Akon cresceu 4.800% em pesquisas no Google, sendo esta fama e repercussão do meme exclusiva e restrita ao Brasil.<!-- Sidebar -->
